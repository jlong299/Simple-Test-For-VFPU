...
//   //??
//   val rshiftBasicF16          = significandWidth + 3
//   val rshiftMaxF16            = 3*significandWidth + 4
...
//   val booth_in_a = Mux(
//     is_fp16,
//     fp_a_significand_f16, 
//     0.U
//   )
//   val booth_in_b = Mux(
//     is_fp16,
//     fp_b_significand_f16,
//     0.U
//   )

//   val U_BoothEncoder = Module(new BoothEncoder(width = significandWidthFP16, is_addend_expand_1bit = true))
...
//     is_fp16_reg0,
//     Cat(U_CSAnto2.io.out_car.head(significandWidthFP16*2), is_sub_f16_reg0 & !rshift_guard_f16 & !rshift_round_f16 & !rshift_sticky_f16),
//     0.U
//   )
//   val CSA3to2_in_c = Mux(
//     is_fp16_reg0,
//     Cat(0.U,fp_c_rshiftValue_inv_f16_reg0(2*significandWidthFP16-1,0)),
//     0.U
//   )
...
//   // mul result
//   // here maybe some problems
//   val adder_lowbit_f16 = U_CSA3to2.io.out_sum + U_CSA3to2.io.out_car
//   // val adder_lowbit_f16 = adder_lowbit_f16(22,0)

//   val fp_c_rshift_result_high_inv_add0_f16 = fp_c_rshiftValue_inv_f16_reg0.head(significandWidthFP16+3)

//   val fp_c_rshift_result_high_inv_add1 = Mux(is_fp16_reg0,
//     Cat(0.U(3.W),fp_c_rshiftValue_inv_f16_reg0.head(significandWidthFP16+3)),
//     0.U
//   ) + 1.U(1.W)


//   val fp_c_rshift_result_high_inv_add1_f16 = fp_c_rshift_result_high_inv_add1(significandWidthFP16+2,0)
...
//     Mux(is_sub_f16_reg0, ((~Cat(rshift_guard_f16,rshift_round_f16,rshift_sticky_f16)).asUInt+1.U).head(2), Cat(rshift_guard_f16,rshift_round_f16))
//   )
...
//   val E_greater_f16_reg2 = RegEnable(RegEnable(RegEnable(Mux(Eab_is_greater_f16, Eab_f16(exponentWidthFP16,0).asUInt, Cat(0.U(1.W),Ec_fix_f16)), fire), fire_reg0), fire_reg1)
//   val lshift_value_max_f16_reg0 = RegEnable(Mux(Eab_is_greater_f16, Eab_f16(exponentWidthFP16,0).asUInt - 1.U, Cat(0.U,Ec_fix_f16 - 1.U)), fire)
...
//   val lshift_adder_inv_f16    = Cat(Mux(RegEnable(adder_is_negative_f16, fire_reg0),~lshift_adder_f16.head(significandWidthFP16+4),lshift_adder_f16.head(significandWidthFP16+4)),lshift_adder_f16.tail(significandWidthFP16+4))
...
//   val fraction_result_no_round_f16_reg2  = RegEnable(lshift_adder_inv_fix_f16.tail(1).head(significandWidthFP16-1), fire_reg1)
...
//   val sticky_f16_reg2  = RegEnable(RegEnable(rshift_sticky_f16, fire_reg0) | (lzd_adder_inv_mask_f16_reg1 + tzd_adder_f16_reg1 < (adder_inv_f16.getWidth-significandWidthFP16-2).U), fire_reg1)
//   val sticky_uf_f16_reg2  = RegEnable(RegEnable(rshift_sticky_f16, fire_reg0) | (lzd_adder_inv_mask_f16_reg1 + tzd_adder_f16_reg1 < (adder_inv_f16.getWidth-significandWidthFP16-3).U), fire_reg1)
//   val round_lshift_f16_reg2 = RegEnable(lshift_adder_inv_fix_f16.tail(significandWidthFP16+1).head(1), fire_reg1)
//   val guard_lshift_f16_reg2 = RegEnable(lshift_adder_inv_fix_f16.tail(significandWidthFP16).head(1), fire_reg1)
...
//   val round_lshift_uf_f16_reg2 = RegEnable(lshift_adder_inv_fix_f16.tail(significandWidthFP16+2).head(1), fire_reg1)
...
//     Cat(0.U((exponentWidthFP16-1).W),exponent_add_1_f16),
//     exponent_result_add_value_f16(exponentWidthFP16-1,0)
//   )
...
//   val result_overflow_up_f16   = Cat(sign_result_temp_f16_reg2, Fill(exponentWidthFP16,1.U), 0.U((significandWidthFP16-1).W))
//   val result_overflow_down_f16 = Cat(sign_result_temp_f16_reg2, Fill(exponentWidthFP16-1,1.U), 0.U, Fill(significandWidthFP16-1,1.U))
...
//   val result_inf_f16 = Cat(Fill(exponentWidthFP16,1.U),Fill(significandWidthFP16-1,0.U))

//   val result_nan_f16 = Cat(0.U,Fill(exponentWidthFP16+1,1.U),0.U((significandWidthFP16-2).W))
